...
export default delay(
  {
    'GET /api/message/getAll': (req, res) =>
      authorizeIntercept({ request: req, response: res }, getAll),
    'GET /api/message/getMessages': (req, res) =>
      authorizeIntercept({ request: req, response: res }, getMessages),
    'GET /api/message/getTodos': (req, res) =>
